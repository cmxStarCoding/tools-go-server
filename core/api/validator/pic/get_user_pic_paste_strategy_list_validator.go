...
type GetUserPicPasteStrategyListRequest struct {
...
func ValidateGetUserPicPasteStrategyListRequest(c *gin.Context) (*GetUserPicPasteStrategyListRequest, error) {
	var request GetUserPicPasteStrategyListRequest
