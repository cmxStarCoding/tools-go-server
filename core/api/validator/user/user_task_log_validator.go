...
type GetUserTaskLogListRequest struct {
...
func ValidateGetUserTaskLogListRequest(c *gin.Context) (*GetUserTaskLogListRequest, error) {
	var request GetUserTaskLogListRequest
