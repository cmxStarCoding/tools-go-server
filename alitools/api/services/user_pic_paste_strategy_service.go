...
func (s UserPicPasteStrategyService) GetUserPicPasteStrategyList(requestData *validator.GetUserPicPasteStrategyListRequest, UserId uint) (map[string]interface{}, error) {
	var total int64
...
func (s UserPicPasteStrategyService) editUserPicPasteStrategyService(requestData *validator.SaveUserPicPasteStrategyRequest, UserId uint) (models.UserPicPasteStrategyModel, error) {
...
func (s UserPicPasteStrategyService) createUserPicPasteStrategyService(requestData *validator.SaveUserPicPasteStrategyRequest, UserId uint) (models.UserPicPasteStrategyModel, error) {
	userPicPasteStrategy := models.UserPicPasteStrategyModel{
		UserId:           UserId,
...
func (s UserPicPasteStrategyService) SaveUserPicPasteStrategy(requestData *validator.SaveUserPicPasteStrategyRequest, UserId uint) (models.UserPicPasteStrategyModel, error) {
	//更新
	if requestData.ID > 0 {
